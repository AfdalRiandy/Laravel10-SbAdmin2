...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.reports.sales') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" class="text-center text-success">
                                        <i class="fas fa-check-circle"></i> Semua produk stok aman
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
                    ...
                    <a href="{{ route('admin.products.index') }}" class="btn btn-primary btn-sm">Lihat Semua Produk</a>
                </div>
            </div>
        </div>
    </div>
...
var categoryChart = new Chart(ctx2, {
    ...
    data: {
        ...
        datasets: [{
            data: @json($categoriesData->pluck('count')),
            backgroundColor: [
